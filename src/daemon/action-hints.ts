...
export const ACTION_HINTS: Partial<Record<string, ActionHint>> = {
  ...
  [Actions.LIST_STRANGERS]: { description: "获取陌生人列表", paramsHint: "无" },
  [Actions.GET_PROFILE]: { description: "获取详细资料卡", paramsHint: "user_id 或 uid（string）" },
  [Actions.GET_STATUS]: { description: "获取当前在线状态", paramsHint: "无" },
  [Actions.GET_ONLINE_STATUS]: { description: "向服务器查询在线状态", paramsHint: "无" },
  ...
  [Actions.HISTORY_BY_MSG_ID]: { description: "以 message_id 为锚点拉历史", paramsHint: "message_id, count?" },
  ...
  [Actions.FRIEND_FORWARD_FILE]: {
    description: "转发私聊文件到群/临时",
    paramsHint: "user_id, fid, group_id?",
  },
  [Actions.SEARCH_SAME_GROUP]: { description: "查找与用户的共群", paramsHint: "user_id" },
  [Actions.SEND_CONTACT_SHARE]: {
    description: "发送链接分享卡片",
    paramsHint: "user_id 或 group_id, url, title, image?, content?, audio?",
  },
  [Actions.GROUP_SET_REACTION]: { description: "给群消息添加表态", paramsHint: "message_id, id" },
  [Actions.GROUP_DEL_REACTION]: { description: "取消群消息表态", paramsHint: "message_id, id" },
  ...
  [Actions.GET_CHANNEL_INFO]: { description: "获取子频道详情", paramsHint: "guild_id, channel_id" },
  ...
  [Actions.UID2UINS]: { description: "批量 UID 转 UIN", paramsHint: "uids (string[]), group_id?" },
  [Actions.UIN2UID]: { description: "UIN 转 UID", paramsHint: "uin, group_id?" },
  [Actions.UIN2UIDS]: { description: "批量 UIN 转 UID", paramsHint: "uins (number[]), group_id?" },
  [Actions.GET_COOKIES]: { description: "获取 Cookies", paramsHint: "domain?" },
  [Actions.GET_CSRF_TOKEN]: { description: "获取 CSRF Token (bkn)", paramsHint: "无" },
  [Actions.REFRESH_NT_PIC_RKEY]: { description: "刷新 QQNT 图片 rkey", paramsHint: "force?" },
  [Actions.SEND_DISCUSS_MSG]: { description: "发送讨论组消息", paramsHint: "discuss_id, message" },
